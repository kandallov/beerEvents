...
public extension UITableView {
    ...
    public func dequeueReusableCell<T: UITableViewCell>(withClass mClass: T.Type, for indexPath: IndexPath) -> T {
        register(mClass)
    ...
    public func dequeueReusableHeaderFooterView(withClass mClass: AnyClass) -> UITableViewHeaderFooterView? {
